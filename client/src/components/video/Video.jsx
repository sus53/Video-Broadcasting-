...
function Video() {
    ...
    try {
        window.localStorage.setItem("state", state.title)
        window.localStorage.setItem("Live", state.live)
        title = state.title;
        live = state.live;
    } catch (error) {
        title = window.localStorage.getItem('state');
        live = window.localStorage.getItem('Live');
    }
    ...
    let videoURL = require("../../assets/video/" + sport);
    ...
    return (
        <div className='video-page'>
            <div className='video-video'>
                <div>
                    <video autoPlay loop controls={Live} src={videoURL} >
                    </video>
